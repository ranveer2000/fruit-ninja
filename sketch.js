...
var splashs,ku;
var splash1,splash2,splash3,splash4;
var splashGroup;
function preload(){
...
function splash(x,y){
    ...
    if (ku === 1){
      ...
      splashs.addImage(splash2);
    } else if (ku === 3){
      splashs.addImage(splash3);
    } else if (ku === 4){
      splashs.addImage(splash4);
    }
    splashGroup.add(splashs);
}
function fruits(){
